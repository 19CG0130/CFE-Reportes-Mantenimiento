                    ...
                    <div class="flex flex-column sm:flex-row flex-wrap items-center justify-between pb-4">
                        <div class="flex-1">
                            <button id="dropdownRadioButton" data-dropdown-toggle="dropdownRadio"
                                ...
                                type="button">
                                <svg class="w-8 h-8 px-1 text-gray-500 dark:text-gray-400 me-3" aria-hidden="true"
                        ...
                        <!--MODAL SELECCIONAR TP,PC,TABLET-->
                                        ...
                                        <div class="p-4 md:p-5">
                                            ...
                                            <ul class="space-y-4 mb-4">
                                                <li>
                                                    ...
                                                    <a href="{{ route('registro_mantenimiento') }}" for="job-1"
                                                        ...
                                                        <div class="flex items-center">
                                                            ...
                                                            <div class="w-full text-lg font-semibold">Computadora de
                                                                Escritorio
                                                            </div>
                                                ...
                                                <li>
                                                    ...
                                                    <a href="{{ route('registro_mantenimiento') }}" for="job-1"
                                                        ...
                                                        <div class="flex items-center">
                                                            ...
                                                            <div class="w-full text-lg font-semibold">Terminal Portatil
                                                            </div>
